...
% Algo 4.3
    elseif Algo == 4.3
        ...
        if exist('QMatrix','var') && ~isempty(QMatrix)
            disp("Q Matrix:");
            disp(QMatrix);
        ...
        while checkMatrix == true
            ...
            if skipSetup == 0
            fprintf(['Insert 3x3 Q matrix, left to right, top to bottom:\n\n' ...
             '          Q11   Q12   Q13\n' ...
             '    Q = [ Q21   Q22   Q23 ]\n' ...
             '          Q31   Q32   Q33\n\n']);
        ...
        [eulerAlpha, eulerBeta, eulerGamma] = Algorithm_4_3(QMatrix)
...
% Algo 4.4
    elseif Algo == 4.4
        ...
        [yaw, pitch, roll] = Algorithm_4_4(QMatrix)
